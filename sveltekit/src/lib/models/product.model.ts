//https://github.com/ivanhofer/sveltekit-typescript-showcase/blob/main/src/models/product.model.ts
...
// @ts-expect-error but we can't assign a normal string to it
productId = '1234'

const categoryId = '123' as CategoryId

// even if both Ids have '123' as their value, TypeScript tells us that these types are incompatible
// @ts-expect-error even if both Ids have '123' as their value, TypeScript tells us that these types are incompatible
...
// @ts-expect-error we cant pass a `CategoryId` to the function
